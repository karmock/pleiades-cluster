...
void TypographyStack::NormalizeLink::SetCollateSelectedFixed(StreamIdSet *Map){
	this->MinSourceLinkPattern=PatternFixed;
}
if(CollateButton==Stream_Collate){
	PageButton=Install.SelectedPattern;
